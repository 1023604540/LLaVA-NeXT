...
RUN_NAME="llava-onevision-0.5b-qwen2_KIT_position_8tokens_initial_correct_further"
...
PREV_STAGE_CHECKPOINT="/hkfs/work/workspace/scratch/tum_tyz7686-LLaVA-OV/checkpoints/llava-onevision-0.5b-qwen2_KIT_position_8tokens_initial_correct/checkpoint-800"
